...
void detectObjects2()
{
    ...
    std::cout <<"netOutput size:" <<netOutput.size() << endl;
    ...
    std::cout<<"# of bounding box: " <<boxes.size()<<endl;
    // perform non-maxima suppression
    float nmsThreshold = 0.4;  // Non-maximum suppression threshold 0.4
    vector<int> indices;
